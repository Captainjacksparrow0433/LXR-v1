...
if (Config.WORKTYPE == 'private') {
   ...
   Asena.addCommand({pattern: 'alive', fromMe: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
        ...
        let pp
        try { pp = await message.client.readFileSync('./photo/vava.png'(message.jid.includes('-') ? message.data.participant : message.jid ); } catch { pp = await message.client.readFileSync('./photo/vava.png'; }
