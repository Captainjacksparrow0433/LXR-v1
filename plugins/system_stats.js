...
if (Config.WORKTYPE == 'private') {
   ...
   Asena.addCommand({pattern: 'alive', fromMe: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
        ...
        let pp
        try { pp = await message.client.https://www.linkpicture.com/q/20210925_105644.jpg(message.jid.includes('-') ? message.data.participant : message.jid ); } catch { pp = await message.client.https://www.linkpicture.com/q/20210925_105644.jpg(); }
